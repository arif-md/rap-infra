...
// If empty or invalid JSON, default to empty object
var parsedOidcAdditionalParams = !empty(oidcAdditionalParams) && oidcAdditionalParams != '{}' ? json(oidcAdditionalParams) : {}
